...
25% sDAI`}
                ...
                <div className="own-pool">you own {token.own_pool}% of the pool</div>
                <div className="grad-wrap deposit-wrap">
                    <div className=" deposit">
                        <div className="deposit-amount">{token.deposited} <span>tokens deposited</span></div>
                ...
                <div className="grad-wrap claim-wrap">
                    <div className=" claim">
                        ...
                        <div className="dea-amount">{token.claimable} DEA </div>
