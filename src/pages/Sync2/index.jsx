...
<<<<<<< HEAD
  ...
  useEffect(() => {
    ...
    } else if (amountOut === "" || debouncedAmountOut === "") setAmountIn("");
...
>>>>>>> 684d151eef89a9b8a3953a5b5780928ed6060d6a
          ...
          : {
              ...toCurrency,
              address: toCurrency.short.address,
              symbol: toCurrency.short_symbol,
            };
        setToCurrency({ ...currency });
      } else {
        const currency = isLong
...
<<<<<<< HEAD
          : {
              ...
              symbol: fromCurrency.short_symbol,
            };
        setFromCurrency({ ...currency });
      }
=======
...
<<<<<<< HEAD
  ...
  const priceSymbol =
    targetCurrency && targetCurrency.long_symbol?.substring(1);
...
>>>>>>> 684d151eef89a9b8a3953a5b5780928ed6060d6a
  ...
  const { getAmountsIn } = useAmountsIn(
    fromCurrency,
    toCurrency,
    debouncedAmountOut,
    assetInfo
  ...
  useEffect(() => {
    const get = async () => {
      ...
      if (amountIn === "" || isZero(amountIn)) setAmountOut("");
        ...
        setAmountOut(
          RemoveTrailingZero(
            fromWei(result, toCurrency.decimals),
            toCurrency.decimals
          )
        );
    };
  ...
  useEffect(() => {
    const get = async () => {
      ...
      if (amountOut === "" || isZero(amountOut)) setAmountIn("");
        ...
        setAmountIn(
          RemoveTrailingZero(
            fromWei(result, fromCurrency.decimals),
