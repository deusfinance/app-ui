...
width: 50%;
`
const SwapAction = ({ text = "SWAP", isPreApproved, amountIn, swapState, TokensMap, isApproved, loading, swapLoading = false, validNetworks = [4, 1], handleApprove, handleSwap, bgColor, targetToken }) => {
