...
import { Lock, Clock, BarChart, Calendar, User, BarChart2, Info, Upload } from 'react-feather';
import ReactTooltip from "react-tooltip";
import "./style.scss";
import "react-datepicker/dist/react-datepicker.css";
import { MainWrap, ItemsWrap, MainTitle, Description, IntroWrap } from '../../components/App/VeDeus/index';
import Days from '../../components/App/VeDeus/Days';
                ...
                <div className="xlqdr-action-left-wrap">
                    <div className="xlqdr-action-generate card-wrapper">
                        ...
                        <div className="action-para-top">
                            ...
                            <div className="value">
                                {!account ? "-" : formatBalance3(deusBalance)}{" DEUS"}
                            </div>
                        </div>
