...
const AutomaticMarketMakerAddr = '0xD77700fC3C78d1Cb3aCb1a9eAC891ff59bC7946D'
...
const DEUSTokenAddr = '0x3b62f3820e0b035cc4ad602dece6d796bc325325';

const INFURA_URL = 'wss://mainnet.infura.io/ws/v3/cf6ea736e00b4ee4bc43dfdb68f51093';
...
function sellToken(tokenAmount, etherAmount, listener) {
    console.log(tokenAmount, etherAmount);
    return window.ethereum.enable().then(r => {
        let metamaskWeb3 = new Web3(Web3.givenProvider);
        AutomaticMarketMakerContract = new metamaskWeb3.eth.Contract(AutomaticMarketMakerABI, AutomaticMarketMakerAddr);
