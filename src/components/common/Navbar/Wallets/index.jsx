...
function getErrorMessage(error) {
  ...
  if (error instanceof NoEthereumProviderError) {
    return 'No Wallet detected, install MetaMask on desktop or visit from a dApp browser on mobile.'
    ...
    return 'Please change your wallet network'
  }
  else {
        ...
        <div className="wallets">
          ...
          {displayErrorBox && (
            <div className="wallet error">
              ...
              <div className="wallet-msg">{getErrorMessage(error)}</div>
