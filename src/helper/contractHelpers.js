...
export const getCollateralPoolContract = (
  web3,
...
export const getUsdcTwapOracleContract = (
  web3,
  chainId = ChainId.AVALANCHE
) => {
  return getContract(
    UsdcTwapOracleAbi,
    USDC_TWAP_ORACLE_ADDRESS[chainId],
    web3
  );
};
...
export const getBakktMigrationContract = (web3, chainId = ChainId.ETH) => {
  return getContract(
    BakktAbi,
    "0x702ed7074b2ee71896d386efaf78e1ddc221e34e",
    web3,
    chainId
  );
};
...
export const getMuonContract = (web3, chainId = ChainId.MATIC) => {
  return getContract(
    MuonPresaleCrossChainAbi,
    MUON_PRESALE_ADDRESS[chainId],
    web3
  );
};
